...
#from transferLearning import tl_model as tlModel, tl_dataset_devision as tlDataDev, tl_training as tlTrain, tl_evaluation as tlEval
...
'''
#tlModel.calculateAndSaveEmbeddings()
